      ...
      <main className="flex-1 pt-20">
        ...
        <section className="py-16 bg-gradient-to-b from-primary/10 to-background">
          <div className="container mx-auto px-4">
            <Link to="/#home" className="inline-flex items-center gap-2 text-primary hover:text-primary/80 transition-colors mb-8">
            ...
            <div className="max-w-4xl mx-auto text-center">
              ...
              <div className="grid sm:grid-cols-3 gap-8">
                <div className="bg-card rounded-xl p-6 border border-border shadow-sm">
                  ...
                  <h3 className="font-bold text-foreground mb-2">Licensed & Regulated</h3>
                  <p className="text-muted-foreground text-sm">Licensed by the Bank of Ghana, ensuring your safety and trust.</p>
                </div>
                ...
                <div className="bg-card rounded-xl p-6 border border-border shadow-sm">
                  ...
                  <h3 className="font-bold text-foreground mb-2">Local Presence</h3>
                  <p className="text-muted-foreground text-sm">Based in Teshie, Accra – we understand the local business landscape.</p>
                </div>
                ...
                <div className="bg-card rounded-xl p-6 border border-border shadow-sm">
                  ...
                  <p className="text-muted-foreground text-sm">1,000+ satisfied clients and GHS 2M+ in loans disbursed.</p>
                </div>
              </div>
